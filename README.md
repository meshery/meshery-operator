...
We 💚 contributions - all types are welcome. Meshery Operator is a [Kubebuilder](https://book.kubebuilder.io)-based Kubernetes operator; every build, test, and deploy workflow is driven by the [`Makefile`](Makefile). Run `make help` for the categorized list of targets.

👉 **Start here:** [Contributing to Meshery Operator](https://docs.meshery.io/project/contributing/contributing-operator) walks through the prerequisites and how to build, test, and deploy the operator from source. For deeper local detail see [`docs/development.md`](docs/development.md) and [`docs/testing.md`](docs/testing.md), and for a tour of community resources see the general [Contributor Guides](https://docs.meshery.io/project/contributing).
