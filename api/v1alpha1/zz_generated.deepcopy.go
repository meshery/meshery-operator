...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ListenerConfigs) DeepCopyInto(out *ListenerConfigs) {
	{
		in := &in
		*out = make(ListenerConfigs, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ListenerConfigs.
func (in ListenerConfigs) DeepCopy() ListenerConfigs {
	if in == nil {
		return nil
	}
	out := new(ListenerConfigs)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeshsyncConfig) DeepCopyInto(out *MeshsyncConfig) {
	*out = *in
	if in.PipelineConfigs != nil {
		in, out := &in.PipelineConfigs, &out.PipelineConfigs
		*out = make(map[string]PipelineConfigs, len(*in))
		for key, val := range *in {
			var outVal []PipelineConfig
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(PipelineConfigs, len(*in))
				copy(*out, *in)
			}
			(*out)[key] = outVal
		}
	}
	if in.ListenerConfigs != nil {
		in, out := &in.ListenerConfigs, &out.ListenerConfigs
		*out = make(map[string]ListenerConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeshsyncConfig.
func (in *MeshsyncConfig) DeepCopy() *MeshsyncConfig {
	if in == nil {
		return nil
	}
	out := new(MeshsyncConfig)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in PipelineConfigs) DeepCopyInto(out *PipelineConfigs) {
	{
		in := &in
		*out = make(PipelineConfigs, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineConfigs.
func (in PipelineConfigs) DeepCopy() PipelineConfigs {
	if in == nil {
		return nil
	}
	out := new(PipelineConfigs)
	in.DeepCopyInto(out)
	return *out
}
